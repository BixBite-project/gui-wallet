                ...
                app_hub.on_tx_detail_found_event.connect(function(tx_detail_json){
                    ...
                    if(tx.hasOwnProperty('destinations')){
                        ...
                        for(var i=0; i < destinations.length; i++ ){
                            dest_html += '<li>Amount: <span class="tx-list tx-amount tx-' + tx['status'] + '">' + printMoney(destinations[i]['amount']/10000) + "</span>Address: <strong>" + destinations[i]['address'] + "</strong></li>";
                        }
                    }
                    ...
                    var tx_rendered = Mustache.render(tx_row_tmpl, 
                                                        {   'cls_in_out': tx['status'],
                                                            ...
                                                            'tx_amount': printMoney(tx['amount']/10000.),
                                                            'tx_fee': printMoney(tx['fee']/10000.),
    ...
    <body>
        <div class="container">
            <ul class="nav nav-tabs">
			  ...
			  <li><a data-toggle="tab" href="#exchange_tab"><i class="fa fa-exchange"></i> Atomic exchange</a></li>
            ...
            <div class="tab-content" style="height:490px; margin-top:20px;">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-xs-6" style="text-align:right">
                                <h5><span id="balance">0.0000</span> <small>BXB</small> <span class="syncing"> (syncing)</span></h5>
                                <h5><span id="unlocked_balance">0.0000</span> <small>BXB</small> <span class="syncing"> (syncing)</span></h5>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-xs-8">
                                        <select id="send_mixins" class="form-control">
                                          <option value="1" selected>1 mixins (default)</option>
                                          <option value="2">2 mixins</option>
                                          <option value="3">3 mixins</option>
                                          <option value="4">4 mixins</option>
                                          <option value="5">5 mixins</option>
                                          <option value="6">6 mixins</option>
                                          <option value="7">7 mixins</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
				...
				<div id="exchange_tab" class="tab-pane fade">
                    ...
                    <form id="form_send_tx" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
							 ...
							 <div class="form-group">
                                <div class="col-sm-12">
                                    <label for="send_visa" class="col-xs-2 control-label"><i class="fa fa-cc-visa" aria-hidden="true"></i> Visa</label>
                                    <div class="col-xs-10 input-group" style="padding-left: 15px; padding-right: 15px;">
                                        <input id="send_address" type="text" class="form-control"  placeholder="Paste receiving address here (Ctrl+V)..." maxlength="16"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12" style="text-align: center">
                                    <button id="btn_exchange" type="button" class="btn btn-success" onclick="send_tx()" disabled><i class="fa fa-send"></i> Exchange</button>
                                </div>
                            </div>
							<div class="form-group">
                                <div class="col-sm-12">
                                    <label class="col-xs-2 control-label sr-only">&nbsp;</label>
                                    <div class="col-sm-12" style="text-align: center">
                                        <label style="color:red">Warning!<br/>This function is currently under development</label>
                                    </div>
                                </div>
                            </div>	
                        </fieldset>
        ...
        <script id="recent_tx_row_templ" type="x-tmpl-mustache">
            <div class="col-sm-12">
                <div class="col-xs-10" style="padding-right:0">
                    <p class="tx-list tx-{{cls_in_out}}"><i class="fa fa-{{ tx_fa_icon }}"></i> ({{tx_direction}}) <span class="tx-list txid"><a href="javascript:open_link('http://explorer.bixbite.pro/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span></p>
                ...
                <div class="col-xs-2">
                    <button class="btn btn-primary" onclick="view_tx_detail('{{ tx_height }}', '{{ tx_id }}')">Details</button>
                </div>
        ...
        <script id="tx_detail_templ" type="x-tmpl-mustache">
            <p class="tx-list tx-{{cls_in_out}}" style="font-size: 90%"><i class="fa fa-{{ tx_fa_icon }}"></i> {{tx_direction}}<br>
                <span class="tx-list txid"><a href="javascript:open_link('http://explorer.bixbite.pro/tx/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span>
            </p>
