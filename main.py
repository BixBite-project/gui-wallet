...
file_hashes = [
        ...
        ('www/scripts/utils.js', '25d71d7673a7e08ce28a0a19425d5ae1a45f434f56e9fb8a5cc267f7c7ca82d6'),
        
        ('www/css/bootstrap.min.css', '75ad97faa0f246fbfc38e6b04f91d8a00d2474928f4f7ecb32a3f68cad67f76e'),
...
def main():
    ...
    app.setOrganizationName('Bixbite')
    app.setOrganizationDomain('www.bixbite.pro')
